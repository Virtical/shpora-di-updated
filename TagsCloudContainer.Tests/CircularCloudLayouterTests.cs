...
public class CircularCloudLayouterTests
{
    ...
    public void CloudSizeEqualsFirstTagSize_WhenPuttingFirstTag()
    {
        ...
        circularCloudLayouter.PutNextTag(rectangleSize);
    ...
    public void PutNextRectangle_ThrowException_When(int width, int height)
    {
        ...
        var putIncorrectRectangle = () => circularCloudLayouter.PutNextTag(incorrectRectangle);
    ...
    public void PutNextRectangle_PlacesFirstRectangleInCenter_When(int width, int height)
    {
        ...
        var firstRectangle = circularCloudLayouter.PutNextTag(rectangleSize);
    ...
    {
        circularCloudLayouter = new CircularCloudLayouter(Point.Empty);
        circularCloudLayouter.PutNextTag(new Size(50, 25));
        circularCloudLayouter.PutNextTag(new Size(60, 30));
        circularCloudLayouter.PutNextTag(new Size(40, 20));
